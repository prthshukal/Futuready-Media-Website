...
(function($) {
   ...
   // $.scrollIt();
    ...
    $('.navbar-toggle').on("click", function() {
        ...
        var element = $('.navbar-toggle>div');
        var hasClass = element.hasClass('navbar-hamburger hidden');
        var hasClass1 = element.hasClass('navbar-close hidden');
        ...
        {   
            ...
            $(".nav-number").hide();
            $(".nav-video").hide();
            $(".white-bg .l-border").css("display", "none");
            $(".white-bg.header.minimal").css("background-color", "rgba(255, 149, 13, 0.9)");
            $(".l-normal").css("display", "none");
            $(".l-white").css("display", "block");
            $(".white-bg.header.minimal").css("height", "100%");
            $(".white-bg.header .navbar").css("border-bottom", "0px");
            $(".header .navbar").css("border-bottom", "0px");
        }
        ...
        if(hasClass1 === true)
        {
            $(".nav-number").show();
            $(".nav-video").show();
            $(".white-bg .l-border").css("display", "block");
            $(".white-bg.header.minimal").css("background-color", "#ffffff");
            $(".l-normal").css("display", "block");
            $(".l-white").css("display", "none");
            $(".white-bg.header.minimal").css("height", "auto");
            $(".white-bg.header .navbar").css("border-bottom", "1px solid #ccc");
            $(".header .navbar").css("border-bottom", "1px solid rgba(190, 190, 190, 0.4)");
